...
window.OSIP_OPPORTUNITIES = [
    {
        ...
        cost: 'USD 420 m',
        terms: { type: 'Equity and/or debt', share: 'Up to 49% equity', deadline: 'Rolling — register to be notified', currency: 'USD', eligibility: 'Open to local and foreign investors; NIPC registration applies' },
        overview: [
        ...
        gated: ['15.8%', '7.0 yrs', 'USD 2 m', '7 yrs'],
        ...
        contact: ['Ngozi Eze', 'Programme Manager', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2025-WND-02',
        ...
        gated: ['17.4%', '6.2 yrs', 'USD 5 m', '5 yrs'],
        ...
        contact: ['Adebayo Okonkwo', 'Director of Operations', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2024-STG-07',
        track: 'readiness',   // shown on the readiness axis; Seeking investor interest
        title: 'Nasarawa Grid-Scale Battery Storage',
        file: 'Nasarawa-Battery-Storage',
        stage: 2,
        updated: '14-Jan-2026',
        ...
        terms: { type: 'Equity and/or debt', share: 'Up to 49% equity', deadline: 'Rolling — register to be notified', currency: 'USD', eligibility: 'Open to local and foreign investors; NIPC registration applies' },
        overview: [
            'is a proposed grid-scale battery energy storage system (BESS) sited near a major grid injection point in Nasarawa, designed to firm up variable solar generation, provide frequency response and shift daytime solar output into evening peak demand.',
            'The state is seeking investor interest ahead of detailed feasibility, with revenue linked to capacity and ancillary-grid services under the Electricity Act 2023 market. The project opens positions for battery technology partners, EPC contractors and equity investors, licensed by NERC and connected under a TCN grid connection agreement.'
        ],
        highlights: [['battery_charging_full', '400 MWh', 'Storage capacity'], ['bolt', '100 MW', 'Discharge power'], ['map', '1 State', 'Nasarawa'], ['payments', '$350 m', 'Total investment']],
        gated: ['19.2%', '6.8 yrs', 'USD 10 m', '6 yrs'],
        brief: 'The Nasarawa battery storage project is sized at around 100&nbsp;MW / 400&nbsp;MWh to stabilise the regional grid and integrate nearby solar generation, in a phased build that can scale with demand. Indicative capital outlay is USD&nbsp;350&nbsp;m. Feasibility, dispatch model and revenue terms will be confirmed with the investors who come forward, and published here once the responsible agency confirms them.',
        images: [['Battery storage containers', 'osip-nsl-battery'], ['Grid substation', 'osip-nsl-substation'], ['Control room', 'osip-nsl-control'], ['Solar-plus-storage site', 'osip-nsl-site']],
        video: ['Nasarawa Battery Storage: Site Overview', 'osip-nsl-walkthrough'],
        ...
        contact: ['Musa Abdullahi', 'Head of Investment Promotion', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2025-HYD-01',
        ...
        gated: ['14.6%', '8.5 yrs', 'USD 3 m', '8 yrs'],
        ...
        contact: ['Ekaette Bassey', 'Project Coordinator', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2025-MOB-04',
        ...
        gated: ['16.1%', '6.5 yrs', 'USD 1 m', '5 yrs'],
        ...
        contact: ['Tunde Bakare', 'Head of Mobility Projects', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2025-EEF-03',
        ...
        gated: ['18.0%', '4.5 yrs', 'USD 1 m', '4 yrs'],
        ...
        contact: ['Folake Adeyemi', 'Programme Director', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2025-CLC-02',
        ...
        contact: ['Aisha Bello', 'Programme Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2025-BIO-05',
        ...
        gated: ['15.2%', '7.2 yrs', 'USD 2 m', '6 yrs'],
        ...
        contact: ['Terver Akaa', 'Project Manager', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2025-HYG-01',
        ...
        gated: ['12.8%', '9.0 yrs', 'USD 10 m', '8 yrs'],
        ...
        contact: ['Chinedu Okafor', 'Head of Project Development', 'Provided to registered investors', 'Provided to registered investors']
    },
       ...
       and document is an illustrative placeholder, like the records above. */
    {
        ...
        gated: ['16.5%', '6.0 yrs', 'USD 1 m', '5 yrs'],
        ...
        contact: ['Amina Yusuf', 'DARES Investor Desk Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-SOL-22',
        ...
        contact: ['Chukwuemeka Obi', 'Head of C&I Partnerships', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-SOL-23',
        ...
        gated: ['17.0%', '6.5 yrs', 'USD 2 m', '6 yrs'],
        ...
        contact: ['Funmilayo Adebayo', 'Industrial Investment Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-SOL-24',
        ...
        gated: ['15.9%', '6.8 yrs', 'USD 1 m', '6 yrs'],
        ...
        contact: ['Ibrahim Musa', 'Portfolio Development Manager', 'Provided to registered investors', 'Provided to registered investors']
    },
       ...
       their own paragraphs; every figure, date, contact and document is an illustrative placeholder. */
    {
        ...
        gated: ['13.0%', '6.0 yrs', 'USD 1 m', '5 yrs'],
        ...
        contact: ['Adaeze Okonkwo', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-WND-22',
        ...
        gated: ['13.7%', '6.8 yrs', 'USD 2 m', '6 yrs'],
        ...
        docs: [['Investment Memorandum', '2.4', 40], ['Market Assessment', '3.8', 72], ['Environmental and Social Summary', '1.6', 30], ['Indicative Term Sheet', '0.6', 8]],
        contact: ['Emeka Nwosu', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-WND-23',
        ...
        gated: ['14.4%', '7.6 yrs', 'USD 3 m', '7 yrs'],
        ...
        docs: [['Investment Memorandum', '2.4', 40], ['Market Assessment', '3.8', 72], ['Environmental and Social Summary', '1.6', 30], ['Indicative Term Sheet', '0.6', 8]],
        contact: ['Halima Bello', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-WND-24',
        title: 'Geographic Hotspots',
        ...
        gated: ['15.1%', '8.4 yrs', 'USD 1 m', '5 yrs'],
        ...
        docs: [['Investment Memorandum', '2.4', 40], ['Market Assessment', '3.8', 72], ['Environmental and Social Summary', '1.6', 30], ['Indicative Term Sheet', '0.6', 8]],
        contact: ['Tunde Adeyemi', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-STG-21',
        ...
        gated: ['15.8%', '6.0 yrs', 'USD 2 m', '6 yrs'],
        ...
        docs: [['Investment Memorandum', '2.4', 40], ['Market Assessment', '3.8', 72], ['Environmental and Social Summary', '1.6', 30], ['Indicative Term Sheet', '0.6', 8]],
        contact: ['Ngozi Eze', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-STG-22',
        ...
        gated: ['13.0%', '6.8 yrs', 'USD 3 m', '7 yrs'],
        ...
        docs: [['Investment Memorandum', '2.4', 40], ['Market Assessment', '3.8', 72], ['Environmental and Social Summary', '1.6', 30], ['Indicative Term Sheet', '0.6', 8]],
        contact: ['Sani Abdullahi', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-STG-23',
        ...
        gated: ['13.7%', '7.6 yrs', 'USD 1 m', '5 yrs'],
        ...
        docs: [['Investment Memorandum', '2.4', 40], ['Market Assessment', '3.8', 72], ['Environmental and Social Summary', '1.6', 30], ['Indicative Term Sheet', '0.6', 8]],
        contact: ['Folake Ogunleye', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-STG-24',
        ...
        gated: ['14.4%', '8.4 yrs', 'USD 2 m', '6 yrs'],
        ...
        docs: [['Investment Memorandum', '2.4', 40], ['Market Assessment', '3.8', 72], ['Environmental and Social Summary', '1.6', 30], ['Indicative Term Sheet', '0.6', 8]],
        contact: ['Yakubu Danjuma', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-HYD-21',
        ...
        gated: ['15.1%', '6.0 yrs', 'USD 3 m', '7 yrs'],
        ...
        docs: [['Investment Memorandum', '2.4', 40], ['Market Assessment', '3.8', 72], ['Environmental and Social Summary', '1.6', 30], ['Indicative Term Sheet', '0.6', 8]],
        contact: ['Chioma Obi', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-HYD-22',
        ...
        gated: ['15.8%', '6.8 yrs', 'USD 1 m', '5 yrs'],
        ...
        docs: [['Investment Memorandum', '2.4', 40], ['Market Assessment', '3.8', 72], ['Environmental and Social Summary', '1.6', 30], ['Indicative Term Sheet', '0.6', 8]],
        contact: ['Musa Garba', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-HYD-23',
        title: 'Geographic Hotspots',
        ...
        gated: ['13.0%', '7.6 yrs', 'USD 2 m', '6 yrs'],
        ...
        docs: [['Investment Memorandum', '2.4', 40], ['Market Assessment', '3.8', 72], ['Environmental and Social Summary', '1.6', 30], ['Indicative Term Sheet', '0.6', 8]],
        contact: ['Bisi Afolabi', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-MOB-21',
        ...
        gated: ['13.7%', '8.4 yrs', 'USD 3 m', '7 yrs'],
        ...
        docs: [['Investment Memorandum', '2.4', 40], ['Market Assessment', '3.8', 72], ['Environmental and Social Summary', '1.6', 30], ['Indicative Term Sheet', '0.6', 8]],
        contact: ['Ifeanyi Okeke', 'Investor Relations Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-MOB-22',
        ...
        gated: ['14.4%', '6.0 yrs', 'USD 1 m', '5 yrs'],
    ...
    },
    {
        ...
        gated: ['15.1%', '6.8 yrs', 'USD 2 m', '6 yrs'],
        brief: 'Indicative capital outlay is USD&nbsp;160&nbsp;m. Site details, commercial terms and the return profile will be published here once the responsible agency confirms them.',
    ...
    },
    {
        ...
        gated: ['15.8%', '7.6 yrs', 'USD 3 m', '7 yrs'],
    ...
    },
    {
        ...
        gated: ['13.0%', '8.4 yrs', 'USD 1 m', '5 yrs'],
    ...
    },
    {
        ...
        gated: ['13.7%', '6.0 yrs', 'USD 2 m', '6 yrs'],
    ...
    },
    {
        ...
        gated: ['14.4%', '6.8 yrs', 'USD 3 m', '7 yrs'],
        brief: 'Indicative capital outlay is USD&nbsp;110&nbsp;m. Site details, commercial terms and the return profile will be published here once the responsible agency confirms them.',
    ...
    },
    {
        ...
        gated: ['15.1%', '7.6 yrs', 'USD 1 m', '5 yrs'],
    ...
    },
    {
        ...
        gated: ['15.8%', '8.4 yrs', 'USD 2 m', '6 yrs'],
    ...
    },
    {
        ...
        gated: ['13.0%', '6.0 yrs', 'USD 3 m', '7 yrs'],
    ...
    },
    {
        ...
        gated: ['13.7%', '6.8 yrs', 'USD 1 m', '5 yrs'],
    ...
    },
    {
        ...
        gated: ['14.4%', '7.6 yrs', 'USD 2 m', '6 yrs'],
        brief: 'Indicative capital outlay is USD&nbsp;120&nbsp;m. Site details, commercial terms and the return profile will be published here once the responsible agency confirms them.',
    ...
    },
    {
        ...
        gated: ['15.1%', '8.4 yrs', 'USD 3 m', '7 yrs'],
        brief: 'Indicative capital outlay is USD&nbsp;85&nbsp;m. Site details, commercial terms and the return profile will be published here once the responsible agency confirms them.',
    ...
    },
    {
        ...
        gated: ['15.8%', '6.0 yrs', 'USD 1 m', '5 yrs'],
        brief: 'Indicative capital outlay is USD&nbsp;60&nbsp;m. Site details, commercial terms and the return profile will be published here once the responsible agency confirms them.',
    ...
    },
    {
        ...
        gated: ['13.0%', '6.8 yrs', 'USD 2 m', '6 yrs'],
        brief: 'Indicative capital outlay is USD&nbsp;40&nbsp;m. Site details, commercial terms and the return profile will be published here once the responsible agency confirms them.',
    ...
    },
    {
        ...
        gated: ['13.7%', '7.6 yrs', 'USD 3 m', '7 yrs'],
        brief: 'Indicative capital outlay is USD&nbsp;110&nbsp;m. Site details, commercial terms and the return profile will be published here once the responsible agency confirms them.',
    ...
    },
    {
        ...
        gated: ['14.4%', '8.4 yrs', 'USD 1 m', '5 yrs'],
    ...
    },
    {
        ...
        gated: ['15.1%', '6.0 yrs', 'USD 2 m', '6 yrs'],
    ...
    },
    {
        ...
        gated: ['15.8%', '6.8 yrs', 'USD 3 m', '7 yrs'],
       ...
       ESIDA supplies the approved data. */
    {
        ...
        gated: ['16.0%', '7.0 yrs', 'USD 2 m', '7 yrs'],
        ...
        contact: ['Chika Eze', 'Investor Desk Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-ENU-02',
        track: 'readiness',   // shown on the readiness axis; Seeking investor interest
        ...
        gated: ['17.5%', '8.5 yrs', 'USD 25 m', '10 yrs'],
        ...
        contact: ['Emeka Nwosu', 'Programme Lead', 'Provided to registered investors', 'Provided to registered investors']
    },
    {
        id: '2026-ENU-03',
        track: 'readiness',   // shown on the readiness axis; Seeking investor interest
        ...
        gated: ['14.5%', '8.0 yrs', 'USD 1 m', '8 yrs'],
        ...
        contact: ['Adaeze Ugwu', 'Investor Desk', 'Provided to registered investors', 'Provided to registered investors']
    }
];
